...
SuperBitcoin 协议 旨在 让 web3 分散割裂的独立共识区块链扩展技术方案 回归 到 以BTC 为核心且受 BTC 网络共享安全保障的 万链互联 系统上来， 做一个以 BTC为核心且受BTC共识安全保障的可无限扩展的 价值网络上来。 
而 SuperBitcoin 协议 可以类比于 互联网的TCP/IP 协议，以 BTC为核心，闪电网络为 链路通信层，taproot concenus 协议为 扩展层， BEVM-stack 去致力于构建一键起 受BTC 网络共享安全共识的 多链（万链）层， 而之上就是 应用层， 重塑一个 价值互联网。 
